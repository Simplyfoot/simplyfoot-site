      ...
      <div className="max-w-4xl mx-auto bg-white/95 shadow-2xl rounded-3xl px-6 py-12 border border-[#29be4f]/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-items-center mb-12">
          {[
            ...
            { src: Romain, alt: "Romain Pennacchio", name: "Romain Pennacchio", role: "Directeur Technique · Associé" },
            { src: Jean, alt: "Jean Carboni", name: "Jean Carboni", role: "Développeur Expert · Associé" },
          ].map((person) => {
            return (
        ...
        <section className="mb-12">
          ...
          <div className="bg-[#F7F6F3] rounded-xl px-6 py-6 text-[#14482F] shadow-md">
            ...
            <p className="mb-4">
              Après des mois de terrain, de réunions tardives, de tests et d’échanges, naît SimplyFoot : <span className="font-bold text-[#29be4f]">un logiciel pensé avec le cœur, codé avec rigueur, et porté par l’ambition de rendre le quotidien de chaque club plus doux, plus fluide, plus humain.</span>
            </p>
        ...
        <section className="mb-12 text-[#000000]">
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-6 justify-center">
            {[
              ...
              {
                icon: <Heart className="text-[#29be4f] w-16 h-16 mt-1" />,
        ...
        <section className="flex flex-col items-center mt-8">
          ...
          <a
            href="/contact"
            className="px-10 py-4 rounded-lg font-bold text-lg bg-[#29be4f] text-[#14482F] shadow-xl hover:bg-[#68FB7A] transition"
          >
            Contactez-nous
          </a>
        </section>
