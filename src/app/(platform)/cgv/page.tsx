...
export const metadata = buildPlatformMetadata({
  ...
  description: 'Conditions générales de vente de la plateforme Simply. Consultez nos tarifs, modalités et engagements.',
  path: '/cgv',
});
    ...
    <div id="top" className="mx-auto max-w-4xl px-6 py-20">
      <header className="mb-10">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-300">
          Conditions applicables à la souscription et à l’utilisation des offres payantes de
          SimplyFoot.
        </p>
      </header>
      ...
      <article className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="legal prose prose-zinc max-w-none dark:prose-invert">
          ...
          <p>
            ...
            modalités de commercialisation, de facturation et d’utilisation des services payants
            proposés par SimplyFoot, en complément des Conditions Générales d’Utilisation (CGU).
          </p>
          ...
          <p>
            ...
            jours. Le Client professionnel renonce expressément à ce droit en accédant au Service
            dès la souscription.
          </p>
          ...
          <p>
            SimplyFoot se réserve le droit de suspendre ou résilier un compte en cas de
            non-paiement, de manquement grave aux CGV/CGU, ou de tentative de fraude. Une
            notification préalable est adressée au Client sauf urgence manifeste.
          </p>
          ...
          <p>
            ...
            la propriété exclusive de SimplyFoot. Le Client obtient une licence d’usage non
            exclusive et non transférable pour la durée de l’abonnement.
          </p>

          <h2>12. Protection des données</h2>
          <p>
            Les données collectées pour la facturation et la gestion client sont traitées
            conformément au{' '}
            <Link
            ...
            et à la Politique de confidentialité. Le Client dispose d’un droit d’accès, de
          ...
          <p>
            ...
            rechercheront une solution amiable avant toute action judiciaire. À défaut, compétence
            exclusive est attribuée aux tribunaux du ressort du siège social de SimplyFoot.
          </p>
