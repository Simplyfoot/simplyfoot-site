...
export const metadata = buildPlatformMetadata({
  ...
  description: 'Mentions légales de la plateforme Simply. Éditeur, hébergement, propriété intellectuelle.',
    ...
    <div id="top" className="mx-auto max-w-4xl px-6 py-20">
      <header className="mb-10">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-300">
          Informations légales relatives à la société éditrice du site SimplyFoot.fr et à son
          hébergeur.
        </p>
      </header>
      ...
      <article className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="legal prose prose-zinc max-w-none dark:prose-invert">
          ...
          <p>
            Le site <strong>www.simplyfoot.fr</strong> est édité par la société{' '}
            <strong>SimplyFoot SAS</strong>, au capital social de 2 000 €, immatriculée au RCS de
            Paris sous le numéro 991 139 171, dont le siège social est situé au 60 rue François 1er,
            75008 Paris.
          </p>
          ...
          <p>
            ...
            structure, code, etc.) sont la propriété exclusive de SimplyFoot, sauf mention
            contraire. Toute reproduction, représentation, modification, publication ou adaptation,
            totale ou partielle, de ces éléments, quel que soit le moyen ou le procédé utilisé, est
            interdite sans autorisation écrite préalable de SimplyFoot.
          </p>
          ...
          <p>
            ...
            d’omissions ou d’une indisponibilité du service. L’utilisateur reconnaît utiliser le
            site sous sa responsabilité exclusive.
          </p>
          ...
          <p>
            Le présent site est régi par le droit français. En cas de litige, et à défaut de
            solution amiable, compétence exclusive est attribuée aux tribunaux du ressort de Paris.
          </p>
          ...
          <p>
            ...
            <br />• Par courrier : SimplyFoot SAS, 60 rue François 1er, 75008 Paris
          </p>
