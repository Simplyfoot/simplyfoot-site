...
export default function InscriptionPage() {
  return (
    <main className="min-h-screen mt-[-180px] bg-[#14482F] flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
      {/* Effet de fond */}
      <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(70%_50%_at_50%_0%,rgba(91,227,125,0.15),transparent_70%)]" />
      ...
      <motion.div
        ...
        className="bg-[#FFFFFF]/95 rounded-3xl shadow-2xl p-10 border border-[#29be4f]/20 max-w-lg w-full"
      >
        {/* Icône */}
        <div className="flex justify-center mb-6">
          <div className="h-16 w-16 rounded-full bg-[#29be4f]/20 flex items-center justify-center text-[#14482F] shadow-inner">
            <Lock className="h-8 w-8" />
          </div>
        </div>

        {/* Titre */}
        <h1 className="text-3xl font-extrabold text-[#14482F] mb-3">
          Inscriptions fermées
        </h1>

        {/* Message */}
        <p className="text-[#14482F]/80 leading-relaxed mb-4">
          Notre application est actuellement en phase de test avec un groupe de{" "}
          <span className="font-semibold text-[#14482F]">clubs pilotes</span>.
        </p>

        <p className="text-[#14482F]/80 mb-6">
          Restez connectés, <span className="font-semibold text-[#14482F]">SimplyFoot</span> arrive très vite ⚽
        </p>

        {/* Footer */}
        <p className="text-xs text-[#14482F]/60 mt-8">
