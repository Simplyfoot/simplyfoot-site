    ...
    <main id="top" className="mx-auto max-w-4xl px-6 py-20">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-300">
          SimplyFoot accorde une grande importance à la protection de vos données personnelles
          et à la transparence sur leur utilisation.
        </p>
      </header>
      ...
      <section className="mb-8 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <dl className="grid gap-4 sm:grid-cols-2">
          <div>
            <dt className="text-xs uppercase tracking-wide text-zinc-500">Responsable du traitement</dt>
      ...
      <article className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="legal prose prose-zinc max-w-none dark:prose-invert">
          ...
          <p>
            ...
            activité sportive, statistiques, et données techniques de connexion. 
            Aucune donnée sensible (santé, religion, opinions) n’est collectée sans consentement explicite.
          </p>

          <h2>3. Base légale</h2>
          <p>
            Le traitement repose sur&nbsp;: 
            (a) l’exécution d’un contrat (utilisation du Service), 
            (b) le consentement (newsletter, cookies), 
            et (c) l’intérêt légitime de SimplyFoot (amélioration du Service, sécurité, prévention de la fraude).
          </p>

          <h2>4. Destinataires</h2>
          <p>
            Les données sont destinées à SimplyFoot et à ses sous-traitants techniques 
            (hébergeur, prestataires d’e-mails, paiement sécurisé). 
            Aucune donnée n’est vendue à des tiers.
          </p>

          <h2>5. Durée de conservation</h2>
          <p>
            Les données sont conservées le temps nécessaire à la fourniture du Service, 
            puis supprimées ou anonymisées après 24 mois d’inactivité, 
          ...
          <p>
            SimplyFoot héberge et traite toutes les données au sein de l’Union Européenne. 
            Aucun transfert hors UE n’est effectué sans garanties adéquates (clauses types, 
            sous-traitants conformes au RGPD).
          </p>

          {/* ANCRE pour #cookies */}
          <h2 id="cookies" className="scroll-mt-24">9. Gestion des cookies</h2>
          <p>
            Lors de votre navigation sur le site ou l’application, des cookies peuvent être déposés 
            sur votre appareil afin d’assurer le bon fonctionnement du site, mesurer la fréquentation 
            et améliorer votre expérience utilisateur.
          </p>

          <h3>Cookies nécessaires</h3>
          <p>
            Ces cookies garantissent le bon fonctionnement du site (authentification, langue, sécurité). 
          ...
          <p>
            ...
            d’évaluer la fréquentation et l’usage du site. Vous pouvez refuser ces cookies via 
            le bandeau de consentement.
          </p>

          <h3>Gestion du consentement</h3>
          <p>
            Lors de votre première visite, un bandeau vous permet d’accepter ou refuser 
          ...
          <p>
            SimplyFoot peut mettre à jour la présente politique à tout moment. 
