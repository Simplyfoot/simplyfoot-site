...
import Image1 from "../../assets/images/Transport_1.png";
import Image2 from "../../assets/images/coach.png";
...
const FEATURES = [
  {
    ...
    icon: <Bus size={28} className="text-[#29be4f]" />,
    tag: "Logistique",
  },
  {
    ...
    icon: <ShieldCheck size={28} className="text-[#29be4f]" />,
    tag: "Gain de temps",
  },
  {
    ...
    icon: <FileText size={28} className="text-[#29be4f]" />,
    tag: "Suivi",
  },
  {
    ...
    icon: <CalendarDays size={28} className="text-[#29be4f]" />,
    tag: "Organisation",
  },
  {
  ...
  },
  {
    ...
    icon: <BarChart3 size={28} className="text-[#29be4f]" />,
    tag: "Performance",
  },
  {
    ...
    icon: <BadgeCheck size={28} className="text-[#29be4f]" />,
    tag: "Motivation",
  },
  {
    ...
    icon: (
      <div className="flex items-center gap-1 text-[#29be4f]">
  ...
  },
  {
    ...
    icon: <Gift size={28} className="text-[#29be4f]" />,
    tag: "Cohésion",
  },
  {
    ...
    icon: <BellRing size={28} className="text-[#29be4f]" />,
    tag: "Rappels",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-[#29be4f]/40 bg-[#1d3e2e]/50 px-3 py-1 text-xs font-semibold text-[#F8E9CA]/90">
            <span className="h-2 w-2 animate-pulse rounded-full bg-[#29be4f]" />
            Conçu avec des coachs & des parents
          </span>
          <h1 className="mt-4 text-4xl md:text-6xl font-extrabold text-white leading-tight">
            Toutes les fonctionnalités pour <span className="text-[#29be4f]">simplifier</span> et <span className="text-[#29be4f]">motiver</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a href="/contact" className="rounded-xl border border-[#F8E9CA]/60 px-8 py-4 text-lg font-bold text-[#F8E9CA] transition hover:border-[#29be4f] hover:text-[#29be4f] active:scale-[.98]">
              Demander une démo
            </a>
          </div>
        </motion.section>
        ...
        <section className="mt-16" aria-labelledby="features-title">
          <h2 id="features-title" className="text-center text-3xl md:text-4xl font-bold text-[#29be4f]">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f, i) => (
              <motion.article
                ...
                className="group rounded-2xl border border-[#29be4f]/15 bg-[#1d3e2e]/60 p-6 shadow hover:shadow-lg"
              >
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#14482F] ring-1 ring-[#29be4f]/30">
                    {f.icon}
                  </div>
                  <div>
                ...
                <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#29be4f]/25 bg-[#14482F]/60 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-[#29be4f]">
                  {f.tag}
                </div>
              </motion.article>
            ))}
        ...
        <section className="mt-16" aria-labelledby="impact-title">
          <h2 id="impact-title" className="text-center text-3xl md:text-4xl font-bold text-[#29be4f]">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {ROLES_IMPACT.map((b, i) => (
              <motion.div
                ...
                className="rounded-2xl border border-[#29be4f]/15 bg-[#232729] p-6 text-[#F8E9CA] shadow"
              >
                <h3 className="text-white mb-2 font-extrabold">{b.role}</h3>
                <ul className="space-y-2">
                  {b.items.map((t) => (
                    <li key={t} className="flex gap-2"><span className="text-[#29be4f]">•</span><span>{t}</span></li>
                  ))}
                </ul>
              </motion.div>
            ))}
        ...
        <section className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2">
          <motion.div {...fadeUp} transition={{ duration: 0.5 }} className="relative overflow-hidden rounded-2xl border border-[#29be4f]/20 bg-[#232729] p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs">
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Charte signée</span>
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Places visibles</span>
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Rappels auto</span>
            </div>
            <Image src={Image1} alt="Transport SimplyFoot" width={640} height={360} className="mt-4 rounded-xl object-cover" />
          </motion.div>

          <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="relative overflow-hidden rounded-2xl border border-[#29be4f]/20 bg-[#232729] p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs">
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Terrain interactif</span>
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Exports visuels</span>
              <span className="rounded-full bg-[#1d3e2e] px-2.5 py-1 text-[#29be4f] ring-1 ring-[#29be4f]/30">Feuille auto</span>
            </div>
            <Image src={Image2} alt="Compo SimplyFoot" width={640} height={360} className="mt-4 rounded-xl object-cover" />
          </motion.div>
        </section>
