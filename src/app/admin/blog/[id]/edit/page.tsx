  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="rounded-xl border border-white/6 bg-[var(--admin-surface)] p-6 space-y-5">
        <div>
          <label htmlFor="edit-title" className="text-xs font-medium text-white/50 uppercase tracking-wide mb-1.5 block">Titre</label>
          <input id="edit-title" type="text" className="admin-input" defaultValue="Article exemple" />
        </div>
        <div>
          <label htmlFor="edit-content" className="text-xs font-medium text-white/50 uppercase tracking-wide mb-1.5 block">Contenu</label>
          <textarea id="edit-content" className="admin-input min-h-[250px]" defaultValue="Contenu de l'article..." />
        </div>
