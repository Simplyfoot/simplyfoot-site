...
function FeatureCard({ icon, title, description, index }: FeatureCardProps) {
    return (
        <AnimatedCard sport="rugby" index={index}>
            <motion.div
...
export function FeaturesRugby() {
    const t = useTranslations('rugby.features');

    return (
        <SectionBackground sport="rugby" tone="tinted" withPattern>
